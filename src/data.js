...
export const initialAlerts = [
  {id:'AL-017',severity:'critical',type:'Leak pattern',site:'Khula Water District',asset:'DMA K-17',confidence:94,status:'Awaiting approval',time:'21:18'},
  {id:'AL-012',severity:'warning',type:'Reservoir decline',site:'Khula Water District',asset:'Khula North Reservoir',confidence:82,status:'Acknowledged',time:'20:42'},
  {id:'AL-009',severity:'warning',type:'Weather risk',site:'Motswedi Industrial Water Scheme',asset:'Catchment / access road',confidence:76,status:'Watching',time:'19:55'},
...
export const auditSeed = [
  {time:'21:18:31',actor:'GABA Intelligence',action:'AI risk brief created',object:'BR-2026-0919-017',result:'Human approval required'},
  {time:'21:18:14',actor:'Anomaly Engine',action:'Cross-sensor correlation',object:'DMA K-17',result:'Leak probability 0.94'},
  {time:'21:05:09',actor:'Simulator Adapter',action:'Telemetry ingested',object:'F-K17-IN / P-K17-DN',result:'Validated'},
  {time:'20:42:50',actor:'N. Dlamini',action:'Alert acknowledged',object:'AL-012',result:'Investigation assigned'}
];
